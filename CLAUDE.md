...
## 就活の背景（雑談で出たら）
- 30歳・非典型経歴。**学歴より「動く作品＋学ぶ力」で勝負**の方針。経歴不問・スキル重視の入口を狙う。
- 本命候補: **Rapyuta Robotics「RSE Program」**（ロボット経験不問の育成枠。ネックは英語＝社内公用語）。
- 直近の現実路線: 生活の"床"としてロボット/プログラミング教室の講師バイト（尼崎/梅田、未経験OK・週1〜）を並行応募。作品で戦える土俵。
